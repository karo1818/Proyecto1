...
<html>
    ...
    <body background="images/fondo.jpg">
        ...
        <form method="POST" enctype="multipart/form-data" name="medico" action="medico/registrar">
        <div class="header">
         ...
         <div class="segundo">
            <ul class="social">
                ...
                <tr ><td>Ingrese su foto de perfil: </td><td><input type="file" name="imagen" accept="image/jpg, image/gif, image/png image/jpeg" >
                </div><br><br><br>
